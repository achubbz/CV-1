...
% @brief    LaTeX2e Resume for Ansh Chaube
...
%______________________________________________________________________________________________________________________
\begin{document}
\name{\Large Anshuman Chaube}
\begin{resume}

    % Contact Information
    \section{\mysidestyle Contact\\Information}
    Graduate Research Assistant \hfill email: achaube2@illinois.edu \vspace{0mm}\\\vspace{0mm}%
   ...
   %__________________________________________________________________________________________________________________
    ...
    \section{\mysidestyle Research\\Interests}
		Advanced nuclear reactors and fuel cycles, multi-physics
                simulation, energy transitions and decarbonization,
